        ...
        <div className="flex h-16 items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <a 
              ...
              className="flex items-center gap-2 rounded-lg px-2 sm:px-3 py-2 text-slate-700 transition-colors hover:bg-slate-200 hover:bg-none dark:text-slate-50 dark:hover:bg-zinc-800"
